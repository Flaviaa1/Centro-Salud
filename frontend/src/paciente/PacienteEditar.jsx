...
class PacientEditar extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
    ...
    return (
      <Fragment>  <Navs></Navs>
         <Breadcrumb>
              ...
              <Breadcrumb.Item active>Editar Paciente
              </Breadcrumb.Item>
            </Breadcrumb>

      <div className='container'>
      <h2 className="text-center mt-4">Editar Paciente</h2> 
      
      <form action="">
      <div class="form-group">
          <label for="exampleFormControlSelect1">Seleccionar Paciente</label>
...
export default withRouter(PacientEditar)
